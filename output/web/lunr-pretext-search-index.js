...
},
{
  ...
  "number": "0.2.1",
  "title": "Functions.",
  "body": " Functions  function    a function from to    Let and be two sets. A function from to , denoted , is a rule which, given any input  , returns an output  . In this case we write and call the image of under , or the value of at  . Similarly, we say  maps (or sends ) the input to the output .  The set is called the domain of ; the set is called the codomain of .  When we wish to indicate what rule defines the function, we use the elaborated notation . This is read as The function with domain and codomain maps an input to the output . We will sometimes suppress the function name in this notation, writing simply to denote a function with domain and codomain .   "
},
{
  "id": "ss_functions_definitions-3",
  "level": "2",
  "url": "s_functions.html#ss_functions_definitions-3",
  "type": "Example",
  "number": "0.2.2",
  "title": "",
...
},
{
  ...
  "body": " Arithmetic operations as functions   Our familiar arithmetic operations can be expressed as functions whose inputs are pairs of numbers. Using the notational conventions introduced in (with function names supressed), addition is the function , and multiplication is the function .   "
},
{
...
{
  "id": "ss_function_image_properties-4",
  "level": "2",
  "url": "s_functions.html#ss_function_image_properties-4",
  "type": "Example",
  "number": "0.2.8",
...
{
  "id": "ss_function_image_properties-8",
  "level": "2",
  "url": "s_functions.html#ss_function_image_properties-8",
  "type": "Proof",
  "number": "0.2.2.1",
  "title": "",
...
},
{
  "id": "ss_logic_ww-2",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-2",
  "type": "WeBWorK",
  "number": "0.3.11",
  "title": "",
...
},
{
  "id": "ss_logic_ww-3",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-3",
  "type": "WeBWorK",
  "number": "0.3.12",
  "title": "",
...
},
{
  "id": "ss_logic_ww-4",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-4",
  "type": "WeBWorK",
  "number": "0.3.13",
  "title": "",
...
},
{
  "id": "ss_logic_ww-5",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-5",
  "type": "WeBWorK",
  "number": "0.3.14",
  "title": "",
...
},
{
  "id": "ss_logic_ww-6",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-6",
  "type": "WeBWorK",
  "number": "0.3.15",
  "title": "",
...
},
{
  "id": "ss_logic_ww-7",
  "level": "2",
  "url": "s_logic.html#ss_logic_ww-7",
  "type": "WeBWorK",
  "number": "0.3.16",
  "title": "",
  "body": "    Suppose is an indexed family of sets. For each statement below, write the letter of the equivalent symbolic form.                             "
},
{
...
{
  "id": "s_reals_integers_rationals",
  "level": "1",
  "url": "s_reals_integers_rationals.html",
  "type": "Section",
  "number": "1.1",
  "title": "Reals, integers,rationals",
  "body": " Reals, integers,rationals   Real numbers  The typical high school math course makes heavy use of the set of real numbers, denoted , without ever telling you exactly what this set is or how it is constructed. There is a good reason for this. In fact, there was not a satisfactorily rigorous construction of the reals until the 19th century. Furthermore, the two most commonly used constructions are not immediately intuitive and are somewhat technical in nature.  We will follow suit in this course and not construct the reals explicitly. That task is reserved for our (the first quarter of) our sequences in real analysis: Math 320-1 and Math 321-1. What. we will do is identify some of the important key properties of the reals that we will take for granted.  The first set of properties we will discuss are the two main operations of addition and multiplication: .   Anatomy lesson: function and Cartesian product notation  The expressions used in the definition of the real number operations use a combination of function notation (see ) and Cartesian product notation (see ). Let's break it down.  Firstly, in general, given sets and , the set , called the Cartesian product of and , is defined as the set of all pairs , where and : , . Next, the notation denotes a function named whose domain is the set and whose codomain is the set . When we want to give more information about how the function is evaluated on inputs, we include a separate line below using the mapsto symbol : . Putting the two notations together, the expression denotes a function that takes as input a pair of elements , where and , and returns as output an element .    "
},
{
  "id": "rm_real_ops_notation",
  "level": "2",
  "url": "s_reals_integers_rationals.html#rm_real_ops_notation",
  "type": "Remark",
  "number": "1.1.1",
  "title": "Anatomy lesson: function and Cartesian product notation.",
  "body": " Anatomy lesson: function and Cartesian product notation  The expressions used in the definition of the real number operations use a combination of function notation (see ) and Cartesian product notation (see ). Let's break it down.  Firstly, in general, given sets and , the set , called the Cartesian product of and , is defined as the set of all pairs , where and : , . Next, the notation denotes a function named whose domain is the set and whose codomain is the set . When we want to give more information about how the function is evaluated on inputs, we include a separate line below using the mapsto symbol : . Putting the two notations together, the expression denotes a function that takes as input a pair of elements , where and , and returns as output an element .  "
},
{
